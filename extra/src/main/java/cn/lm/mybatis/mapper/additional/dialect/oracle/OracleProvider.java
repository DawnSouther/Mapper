package cn.lm.mybatis.mapper.additional.dialect.oracle;
...
public class OracleProvider extends MapperTemplate {
    ...
    /**
     * <bind name="listNotEmptyCheck" value="@cn.lm.mybatis.mapper.util.OGNL@notEmptyCollectionCheck(list, 'cn.lm.mybatis.mapper.additional.dialect.oracle.DemoCountryMapper.insertList 方法参数为空')"/>
     * INSERT ALL
     ...
     * <bind name="country_idGenIdBind"  value="@cn.lm.mybatis.mapper.genid.GenIdUtil@genId(record, 'countryId', @cn.lm.mybatis.mapper.additional.insertlist.UUIdGenId@class, 'demo_country', 'country_id')"/>
    ...
    public String insertList(MappedStatement ms) {
        ...
        sql.append("<bind name=\"listNotEmptyCheck\" value=\"@cn.lm.mybatis.mapper.util.OGNL@notEmptyCollectionCheck(list, '" + ms.getId() + " 方法参数为空')\"/>\n");
